    ...
    <div className="min-h-full flex flex-col items-center justify-center px-4 py-16">
      <div className="mb-8 flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-zinc-400">Upload a photo — get a 3D printable lamp wireframe</p>
        </div>
      </div>
      <div className={"relative w-full max-w-md rounded-2xl border-2 border-dashed cursor-pointer transition-all duration-200 group "+(drag?"border-amber-400 bg-amber-400/5 scale-[1.01]":"border-zinc-700 bg-zinc-900/50 hover:border-amber-400/60 hover:bg-amber-400/[0.03]")}
        ...
        <div className="px-8 py-14 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-200">{drag?"Drop it!":"Drop a photo here"}</p>
          ...
          <p className="text-xs text-zinc-600 leading-relaxed max-w-xs">Works best with a subject on a plain background. Try a bird, whale, fox, or leaf.</p>
        </div>
